...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebsiteEditText = (String) "http://www.linkedin.com/johnsonpark";
    ...
    public void showAlert() {
        ...
        // Set the dialog title and message.
        myAlertBuilder.setTitle("Good App?");
        myAlertBuilder.setMessage("Click Yes, or No:");
        ...
        myAlertBuilder.setPositiveButton("Yes", new
                DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(getApplicationContext(), "Glad you liked the App",
        ...
        myAlertBuilder.setNegativeButton("No", new
                DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(getApplicationContext(), "Sorry you didn't like the App",
                                Toast.LENGTH_SHORT).show();
                    }
                });
